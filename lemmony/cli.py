...
def main():
    ...
    parser.add_argument("-t","--top-communities-only",help="top X communities based on active users per day (Lemmy only) (default: 10)",type=int,default=10)
    parser.add_argument("-q","--top-instances-only",help="top X instances based on active users per week (Lemmy only) (default: 100)",type=int,default=100)
